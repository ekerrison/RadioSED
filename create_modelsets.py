...
orienti_gp_dict = {
    ...
    "george_model": OrientiModel,
    "george_model_defaults": priors.orienti_gp_defaults,
}
...
snellen_gp_dict = {
    ...
    "george_model": SnellenModel,
    "george_model_defaults": priors.snellen_gp_defaults,
}

# retriggered PS model
retrig_gp_dict = {
    "has_GLEAM": True,
    "model_type": "retriggered_gp",
    "model_func": retriggered_sed_func,
    "plot_colour": "darkviolet",
    "prior_obj": priors.retrig_gp_prior(),
    "george_model": RetriggeredModel,
    "george_model_defaults": priors.retrig_gp_defaults,
}
