...
flux_data, peak_flux_data = parser.retrieve_fluxdata_remote(iau_name = src_iau_name, racs_id = src_racs_name, ra = src_ra, dec = src_dec)
...
#now get some plots!
plotter.update_data(data = flux_data, peak_data = peak_flux_data, name = src_racs_name, savestr_end = '')
